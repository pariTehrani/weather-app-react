...
function Form(){
    ...
    function doajax(event){
        ...
        axios.get('https://api.openweathermap.org/data/2.5/weather?q='+city+'&appid=9d5e9ae00531cc47a1afce47e2f9473b&units=metric')
        ...
        axios.get(`https://api.shecodes.io/weather/v1/forecast?query=${city}&key=56cb6ef4c4t2co40cabe790e0e85623b`)
